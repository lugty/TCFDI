...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:fn="http://www.w3.org/2005/xpath-functions" xmlns:cfdi="http://www.sat.gob.mx/cfd/3" xmlns:ecc="http://www.sat.gob.mx/ecc" xmlns:psgecfd="http://www.sat.gob.mx/psgecfd" xmlns:donat="http://www.sat.gob.mx/donat" xmlns:divisas="http://www.sat.gob.mx/divisas" xmlns:detallista="http://www.sat.gob.mx/detallista" xmlns:ecb="http://www.sat.gob.mx/ecb" xmlns:implocal="http://www.sat.gob.mx/implocal" xmlns:terceros="http://www.sat.gob.mx/terceros" xmlns:iedu="http://www.sat.gob.mx/iedu" xmlns:ventavehiculos="http://www.sat.gob.mx/ventavehiculos" xmlns:pfic="http://www.sat.gob.mx/pfic" xmlns:tpe="http://www.sat.gob.mx/TuristaPasajeroExtranjero" xmlns:leyendasFisc="http://www.sat.gob.mx/leyendasFiscales" xmlns:spei="http://www.sat.gob.mx/spei" xmlns:nomina="http://www.sat.gob.mx/nomina" xmlns:registrofiscal="http://www.sat.gob.mx/registrofiscal" xmlns:pagoenespecie="http://www.sat.gob.mx/pagoenespecie" xmlns:consumodecombustibles="http://www.sat.gob.mx/consumodecombustibles" xmlns:valesdedespensa="http://www.sat.gob.mx/valesdedespensa" xmlns:aerolineas="http://www.sat.gob.mx/aerolineas" xmlns:notariospublicos="http://www.sat.gob.mx/notariospublicos" xmlns:vehiculousado="http://www.sat.gob.mx/vehiculousado" xmlns:servicioparcial="http://www.sat.gob.mx/servicioparcialconstruccion" xmlns:destruccion="http://www.sat.gob.mx/certificadodestruccion" xmlns:decreto="http://www.sat.gob.mx/renovacionysustitucionvehiculos" xmlns:obrasarte="http://www.sat.gob.mx/arteantiguedades" xmlns:aieps="http://www.sat.gob.mx/acreditamiento" xmlns:ecc11="http://www.sat.gob.mx/EstadoDeCuentaCombustible" xmlns:cce="http://www.sat.gob.mx/ComercioExterior" xmlns:ine="http://www.sat.gob.mx/ine" xmlns:nomina12="http://www.sat.gob.mx/nomina12" >
  ...
  <!--
	...
	-->
  <xsl:include href="/xslt/cfdi/utilerias/utilerias.xslt"/>
  <!--<xsl:include href="src/main/resources/xslt/cfdi/utilerias/utilerias.xslt"/>-->
  <!-- 
		En esta sección se define la inclusión de las demás plantillas de transformación para 
		la generación de las cadenas originales de los complementos fiscales 
	-->
  <!--<xsl:include href="src/main/resources/xslt/cfdi/ecc.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/psgecfd.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/donat11.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/divisas.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/ecb.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/detallista.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/implocal.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/terceros11.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/iedu.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/ventavehiculos11.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/pfic.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/leyendasFisc.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/spei.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/nomina11.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/cfdiregistrofiscal.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/pagoenespecie.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/consumodecombustibles.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/valesdedespensa.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/aerolineas.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/notariospublicos.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/vehiculousado.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/servicioparcialconstruccion.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/certificadodedestruccion.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/obrasarteantiguedades.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/AcreditamientoIEPS10.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/ecc11.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/ComercioExterior10.xslt"/>
  <xsl:include href="src/main/resources/xslt/cfdi/ine10.xslt"/>-->

  <xsl:include href="/xslt/cfdi/ecc.xslt"/>
  <xsl:include href="/xslt/cfdi/psgecfd.xslt"/>
  <xsl:include href="/xslt/cfdi/donat11.xslt"/>
  <xsl:include href="/xslt/cfdi/divisas.xslt"/>
  <xsl:include href="/xslt/cfdi/ecb.xslt"/>
  <xsl:include href="/xslt/cfdi/detallista.xslt"/>
  <xsl:include href="/xslt/cfdi/implocal.xslt"/>
  <xsl:include href="/xslt/cfdi/terceros11.xslt"/>
  <xsl:include href="/xslt/cfdi/iedu.xslt"/>
  <xsl:include href="/xslt/cfdi/ventavehiculos11.xslt"/>
  <xsl:include href="/xslt/cfdi/pfic.xslt"/>
  <xsl:include href="/xslt/cfdi/TuristaPasajeroExtranjero.xslt"/>
  <xsl:include href="/xslt/cfdi/leyendasFisc.xslt"/>
  <xsl:include href="/xslt/cfdi/spei.xslt"/>
  <xsl:include href="/xslt/cfdi/nomina11.xslt"/>
  <xsl:include href="/xslt/cfdi/cfdiregistrofiscal.xslt"/>
  <xsl:include href="/xslt/cfdi/pagoenespecie.xslt"/>
  <xsl:include href="/xslt/cfdi/consumodecombustibles.xslt"/>
  <xsl:include href="/xslt/cfdi/valesdedespensa.xslt"/>
  <xsl:include href="/xslt/cfdi/aerolineas.xslt"/>
  <xsl:include href="/xslt/cfdi/notariospublicos.xslt"/>
  <xsl:include href="/xslt/cfdi/vehiculousado.xslt"/>
  <xsl:include href="/xslt/cfdi/servicioparcialconstruccion.xslt"/>
  <xsl:include href="/xslt/cfdi/certificadodedestruccion.xslt"/>
  <xsl:include href="/xslt/cfdi/renovacionysustitucionvehiculos.xslt"/>
  <xsl:include href="/xslt/cfdi/obrasarteantiguedades.xslt"/>
  <xsl:include href="/xslt/cfdi/AcreditamientoIEPS10.xslt"/>
  <xsl:include href="/xslt/cfdi/ecc11.xslt"/>
  <xsl:include href="/xslt/cfdi/ComercioExterior10.xslt"/>
  <xsl:include href="/xslt/cfdi/ine10.xslt"/>
  <xsl:include href="/xslt/cfdi/ine11.xslt"/>
  <xsl:include href="/xslt/cfdi/nomina/nomina12.xslt"/>
